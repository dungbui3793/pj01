...
$(function () {
    ...
    if($(window).width() > 767) {
        $("#man-block").width($(".content .man .man-pc").width()).height($(".content .man").height());
        ...
        $("#man-block").width(0).height(0);
        $(".content .man .man-pc").attr("src","img/man-01.png");
    }

    $(".content .list-hover > div").height($(".content-front .list-hover").height());
